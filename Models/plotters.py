...
def plot_accuracy(accuracy_values, time_periods, user_id):
    ...
    plt.ylabel('Accuracy (%)')
    plt.savefig(f'static/plots/model_accuracy_{user_id}.png')

def plot_error_rate(error_rate_values, time_periods, user_id):
    # Convert datetime.date objects to strings in 'YYYY-MM-DD' format
    time_periods_str = [date.strftime('%Y-%m-%d') for date in time_periods]
    plt.figure(figsize=(8,5))
    ...
    plt.savefig(f'static/plots/model_error_rate_{user_id}.png')

def plot_cumulative_correct_predictions(correct_predictions, time_periods, user_id):
    # Convert datetime.date objects to strings in 'YYYY-MM-DD' format
    time_periods_str = [date.strftime('%Y-%m-%d') for date in time_periods]
    plt.figure(figsize=(8,5))
    ...
    plt.savefig(f'static/plots/model_cumulative_correct_predictions_{user_id}.png')

def plot_cumulative_incorrect_predictions(incorrect_predictions, time_periods, user_id):
    # Convert datetime.date objects to strings in 'YYYY-MM-DD' format
    time_periods_str = [date.strftime('%Y-%m-%d') for date in time_periods]
    plt.figure(figsize=(8,5))
    ...
    plt.savefig(f'static/plots/model_cumulative_incorrect_predictions_{user_id}.png')

def plot_time_to_close(correct_close_times, user_id):
    plt.figure(figsize=(8,5))
    ...
    plt.savefig(f'static/plots/model_time_to_close_correct_{user_id}.png')

def plot_cumulative_profit(profit_values, time_periods, user_id):
    # Convert datetime.date objects to strings in 'YYYY-MM-DD' format
    time_periods_str = [date.strftime('%Y-%m-%d') for date in time_periods]
    plt.figure(figsize=(8,5))
    ...
    plt.savefig(f'static/plots/model_cumulative_profit_{user_id}.png')

def plot_cumulative_loss(loss_values, time_periods, user_id):
    # Convert datetime.date objects to strings in 'YYYY-MM-DD' format
    time_periods_str = [date.strftime('%Y-%m-%d') for date in time_periods]
    plt.figure(figsize=(8,5))
    ...
    plt.savefig(f'static/plots/model_cumulative_loss_{user_id}.png')

def plot_model_sector_breakdown_profits(sector_data, user_id):
    ...
    plt.savefig(f'static/plots/model_sector_breakdown_profits_{user_id}.png')

def plot_model_sector_breakdown_loss(sector_data, user_id):
    sector_data = json.loads(sector_data)
    sectors = list(sector_data.keys())
    counts = list(sector_data.values())
    plt.figure(figsize=(8,5))
    ...
    plt.savefig(f'static/plots/model_sector_breakdown_loss_{user_id}.png')
...
def generate_model_performance_graph(model_scores):
    ...
    return fig.to_html()  # To embed in webpage