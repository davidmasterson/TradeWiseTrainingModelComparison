...
class TestPasswordResets(unittest.TestCase):
    ...
    @patch("PasswordResets.secrets.token_urlsafe")
    @patch("PasswordResets.bcrypt.hashpw")
    @patch("PasswordResets.reset_password_DAOIMPL.insert_password_reset_token")
    def test_create_reset_token(self, mock_insert_token, mock_hashpw, mock_token_urlsafe):
        ...
        password_reset = PasswordResets(user_id=1, token=None, expiration_time=None, hashed_token=None)
    ...
    @patch("reset_password_DAOIMPL.get_hashed_token_and_expiration_for_user")
    ...
    @patch("reset_password_DAOIMPL.delete_user_password_reset_token")
