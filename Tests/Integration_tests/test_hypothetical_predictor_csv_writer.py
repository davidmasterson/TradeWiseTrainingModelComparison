...
class TestCSVWriter(unittest.TestCase):
    ...
    def test_write_temporary_csv_with_string_symbols(self,mock_file, mock_get_price, mock_date):
        """Test CSV writing with a list of string symbols."""
        mock_date.return_value= date(2024, 12, 18)
        ...
        handle = mock_file()
        expected_calls = [
            f"0,AAPL,2024-12-18,100.0.0,1,100.0,,,,N/A,N/A,N/A,N/A,3.0,0.0,N/A,103.0,99.0\n",
            f"1,MSFT,2024-12-18,100.0,1,100.0,,,,N/A,N/A,N/A,N/A,3.0,0.0,N/A,103.0,99.0\n",
            f"2,GOOGL,2024-12-18,100.0,1,100.0,,,,N/A,N/A,N/A,N/A,3.0,0.0,N/A,103.0,99.0\n",
        ]
    ...
    @patch("alpaca_request_methods.get_symbol_current_price")
    @patch("builtins.open", new_callable=mock_open)
    def test_write_temporary_csv_with_tuples(self, mock_file, mock_get_price, mock_date ):
        ...
        handle = mock_file()
        expected_calls = [
            f"0,AAPL,2024-12-18,150.0,1,150.0,,,,N/A,N/A,N/A,N/A,4.5,0.0,N/A,154.5,148.5\n",
            f"1,MSFT,2024-12-18,200.0,1,200.0,,,,N/A,N/A,N/A,N/A,6.0,0.0,N/A,206.0,198.0\n",
        ]
        handle.write.assert_any_call(f"id,symbol,dp,ppps,qty,total_buy,pstring,ds,spps,tsp,sstring,expected,proi,actual,tp1,sop,result,user_id,processed\n")
        handle.write.assert_any_call(expected_calls[0])
        handle.write.assert_any_call(expected_calls[1])
    ...
    @patch("alpaca_request_methods.get_symbol_current_price")
    @patch("builtins.open", new_callable=mock_open)
    def test_write_temporary_csv_with_mixed_symbols(self, mock_file, mock_get_price, mock_date):
        ...
        handle = mock_file()
        expected_calls = [
            f"0,AAPL,2024-12-18,100.0,1,100.0,,,,N/A,N/A,N/A,N/A,3.0,0.0,N/A,103.0,99.0\n",
            f"1,MSFT,2024-12-18,200.0,1,200.0,,,,N/A,N/A,N/A,N/A,6.0,0.0,N/A,206.0,198.0\n",
        ]
        handle.write.assert_any_call(f"id,symbol,dp,ppps,qty,total_buy,pstring,ds,spps,tsp,sstring,expected,proi,actual,tp1,sop,result,user_id,processed\n")
        handle.write.assert_any_call(expected_calls[0])
